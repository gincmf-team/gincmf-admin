...
!(function () {
  ...
  let e;
    ...
    const d = {
      ...
      none: o,
      from (e) {
        return e === null || e === undefined ? c : l(e);
      },
    };
    const u = Array.prototype.indexOf;
    const h = function (e, t) {
      return (n = e), (a = t), u.call(n, a) > -1;
      let n; let a;
    };
    ...
    const w = function (e) {
      const n = v.mac
        ...
        const t = e.split("+");
        const a = p(t, function (e) {
          const t = e.toLowerCase().trim();
          return y(n, t) ? n[t] : e;
        });
      return v.mac ? a.join("").replace(/\s/, "") : a.join("+");
    };
    const A = tinymce.util.Tools.resolve("tinymce.util.I18n");
    const C = [
                        ...
                        return (
                          ...
                          g(C, function (e) {
                            ...
                            function () {
                              ...
                              return typeof e === "function" ? c(e()) : n;
                            },
                            function (e) {
                              const t = e.slug || e.key;
                              return c({
                                name: e.name,
    ...
    const x = tinymce.util.Tools.resolve("tinymce.EditorManager");
    const P = function (e, t) {
      let n;
        let a;
        let o;
          ...
          items: [
            {
              ...
              cells: p(k, function (e) {
                const t = p(e.shortcuts, w).join(" or ");
                return [e.action, t];
              }),
            },
          ],
