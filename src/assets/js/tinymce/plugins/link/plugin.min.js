...
!(function (i) {
  ...
  var n,
      ...
      return {
        onChange: function (t, n) {
          return "url" === n.name
            ...
            ? r(t(), n)
            : ("text" === n.name && u.set(t().text), N.none());
        },
      };
    },
    ...
    st = function (t) {
      ...
      return 0 < n.length ? U.sanitize(n) : N.none();
    },
