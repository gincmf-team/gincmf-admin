...
!(function () {
  ...
  const t = tinymce.util.Tools.resolve("tinymce.PluginManager");
    ...
    const M = function (t, e) {
      const n = t[e];
        const r = t[e + 1];
      if (e < 0 || (e > t.length - 1 && e !== 0)) return !1;
      if (n === h && r === h) return !1;
      const o = t[e + 2];
    ...
    const $ = tinymce.util.Tools.resolve("tinymce.dom.TreeWalker");
    ...
    const G = function (t, e) {
      const n = z(t, e).join("").replace(/\s/g, "");
      return I(n);
    };
    ...
    const L = tinymce.util.Tools.resolve("tinymce.util.Delay");
    const Q = function (t, e) {
      let n;
      (n = e),
