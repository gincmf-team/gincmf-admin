...
!(function (x) {
  ...
  var n,
    ...
    E = function (n, e) {
      for (var t = k(n), r = 0, o = t.length; r < o; r++) {
        var i = t[r];
        e(n[i], i);
      }
    },
    ...
    ln = Array.prototype.indexOf,
    dn = Array.prototype.push,
    mn = function (n, e) {
      return (t = n), (r = e), -1 < ln.call(t, r);
      var t, r;
    },
    gn = function (n, e) {
    ...
    _n = function (n, t) {
      return Mn(n, t).map(function (n) {
        var e = N.detect(n.versionRegexes, t);
    ...
    oe = { tap: O("alloy.tap") },
    ie = O("alloy.focus"),
    ue = O("alloy.blur.post"),
    ce = O("alloy.paste.post"),
    ae = O("alloy.receive"),
    fe = O("alloy.execute"),
    se = O("alloy.focus.item"),
    le = oe.tap,
    de = O("alloy.longpress"),
    me = O("alloy.system.init"),
    ge = O("alloy.system.attached"),
    pe = O("alloy.system.detached"),
    he = O("alloy.focusmanager.shifted"),
    ve = O("alloy.highlight"),
    ye = O("alloy.dehighlight"),
    be = function (n, e) {
      Oe(n, n.element(), e, {});
    },
    xe = function (n, e, t) {
    ...
    ke = {
      fromHtml: function (n, e) {
        var t = (e || x.document).createElement("div");
      ...
      fromTag: function (n, e) {
        var t = (e || x.document).createElement(n);
        return Te(t);
      },
      fromText: function (n, e) {
        var t = (e || x.document).createTextNode(n);
        return Te(t);
      },
      fromDom: Te,
    ...
    Ee =
      ("undefined" != typeof x.window ? x.window : Function("return this;")(),
      function (n) {
    ...
    Ve = function (n, e) {
      var t = e === undefined ? x.document : e.dom();
    ...
    ft = function (e) {
      var n,
        t = Ne(e.element()).bind(function (n) {
  ...
  var gt,
    ...
    Rt = function (u) {
      return function () {
        ...
        for (var t = {}, r = 0; r < n.length; r++) {
          var o = n[r];
          for (var i in o) Ft.call(o, i) && (t[i] = u(t[i], o[i]));
        }
        return t;
      };
    },
    ...
    Nt = At.strict,
    Pt = At.asOption,
    Ht = At.defaultedThunk,
    zt = (At.asDefaultedOptionThunk, At.mergeWithThunk),
    Lt = function (n, e) {
      var t;
      return ((t = {})[n] = e), t;
    },
    ...
    qt = function (n, e) {
      ...
      return 0 < o.errors.length
        ...
        : ((t = o.values),
          (r = e),
          0 < t.length ? Tt(Vt(r, Bt.apply(undefined, t))) : Tt(r));
    },
    Yt = function (n) {
      var e = kt(n);
      return 0 < e.errors.length ? Xt(e.errors) : Tt(e.values);
    },
    Kt = function (n) {
      return rn(n) && 100 < k(n).length
        ? " removed due to size"
    ...
    Fr = function (n, e, t) {
      ...
      return r.orThunk(function () {
        return o(n)
          ? T.none()
          : (function (n, e, t) {
              for (var r = n.dom(), o = Ir(t); r.parentNode; ) {
                r = r.parentNode;
                var i = ke.fromDom(r),
                  u = e(i);
    ...
    io = function (n) {
      var e,
        ...
        c,
        a,
        f = hr("Creating behaviour: " + n.name, oo, n);
      return (
        (e = f.fields),
        (t = f.name),
        (r = f.active),
    ...
    wo = function (n) {
      0 === (vo(n) ? n.dom().classList : ho(n, "class")).length &&
        po(n, "class");
    },
    So = function (n, e) {
    ...
    Eo = [wr("alpha"), wr("omega")],
    Co = io({ fields: Eo, name: "swapping", apis: ko }),
    Do = function (n) {
      var e = n;
      return {
        get: function () {
    ...
    Ro = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
    Vo = tinymce.util.Tools.resolve("tinymce.ThemeManager"),
    Bo = [
      {
        title: "Headings",
        items: [
    ...
    Ao = ["undo", "bold", "italic", "link", "image", "bullist", "styleselect"],
    jo = "formatChanged",
    No = "orientationChanged",
    Po = "dropupDismissed",
    Ho = function (n) {
    ...
    zo = function (n, e) {
      var t,
        r,
        o = je(n).dom(),
        i = ke.fromDom(o.createDocumentFragment()),
        u =
          ((t = e),
  ...
  var Xo,
        ...
        I(qo.get(), e)
          .orThunk(function () {
            ...
            return Dn(n, function (n) {
              return -1 < e.indexOf(n) ? T.some(qo.get()[n]) : T.none();
            });
          })
          .getOr(vt.NORMAL)
      ) {
    ...
    Ko = ["alloy/data/Fields", "alloy/debugging/Debugging"],
    Jo = function (n, e, t) {
      return Yo(n, e, t);
    },
    Qo = O({
    ...
    Zo = O([wr("menu"), wr("selectedMenu")]),
    ni = O([wr("item"), wr("selectedItem")]),
    ei = (O(or(ni().concat(Zo()))), O(or(ni()))),
    ti = Or("initSize", [wr("numColumns"), wr("numRows")]),
    ri = function (n, e, t) {
      !(function () {
        var n = new Error();
    ...
    di = io({ fields: li, name: "receiving", active: Uo }),
    mi = function (n, e, t) {
      var r = e.aria;
      r.update(n, r, t.get());
    },
    ...
    Vi = [oi("onFocus"), Dr("stopMousedown", !1), Dr("ignore", !1)],
    Bi = io({ fields: Vi, name: "focusing", active: Ri, apis: Fi }),
    Ai = function (n) {
    ...
    Hi = function (n, e) {
      var t = n.dom(),
        r = x.window.getComputedStyle(t).getPropertyValue(e);
  ...
  var Qi,
    Zi,
    nu = function (n, e, t) {
      for (var r = n.dom(), o = an(t) ? t : O(!1); r.parentNode; ) {
        r = r.parentNode;
        var i = ke.fromDom(r);
    ...
    ku = function (t, r, n, o) {
      var e = Ki(t.element(), "." + r.highlightClass);
      hn(e, function (e) {
        gn(o, function (n) {
          return n.element() === e;
        }) ||
    ...
    Du = function (n, e, t, r) {
      var o = Ki(n.element(), "." + e.itemClass);
    ...
    _u = function (e, n, t) {
      var r = Ki(e.element(), "." + n.itemClass);
    ...
    Iu = function (t, e, n, r) {
      var o = Ki(t.element(), "." + e.itemClass);
      return wn(o, function (n) {
        return Oo(n, e.highlightClass);
      }).bind(function (n) {
        var e = Ou(n, r, 0, o.length - 1);
    ...
    Bu = io({ fields: Vu, name: "highlighting", apis: Ru }),
    Au = function (n, e, t) {
      e.exists(function (e) {
  ...
  var Nu,
    ...
    Qu = function (n) {
      return (
        ("input" === Ee(n) && "radio" !== lo(n, "type")) || "textarea" === Ee(n)
      );
    },
    Zu = function (n, e, t) {
    ...
    rc = qu(
      ...
      eo.init,
      function (n, e, t, r) {
        var o = t.useSpace && !Qu(n.element()) ? cu() : [],
          i = t.useEnter ? iu() : [],
          u = t.useDown ? lu() : [],
    ...
    cc = function (n) {
      return "rtl" === Hi(n, "direction") ? "rtl" : "ltr";
    },
    ac = function (i) {
    ...
    Ec = Tc(function (n, e, t, r) {
      return xc(n, e, t, r, -1);
    }),
    Cc = Tc(function (n, e, t, r) {
      return xc(n, e, t, r, 1);
    }),
    Dc = Tc(function (n, e, t, r) {
      return wc(n, e, t, r, -1);
    }),
    Mc = Tc(function (n, e, t, r) {
      return wc(n, e, t, r, 1);
    }),
    _c = O([
      wu(hu(au()), fc(Ec, Cc)),
    ...
    Ic = O([wu(hu(cu()), nc)]),
    Fc = qu(Sc, oc, _c, Ic, function () {
      return T.some(Oc);
    }),
    Rc = function (n, e, t, i) {
      var u = function (n, e, t) {
        var r,
          o = Ou(e, i, 0, t.length - 1);
        return o === n
          ? T.none()
          : ((r = t[o]),
            "button" === Ee(r) && "disabled" === lo(r, "disabled")
              ? u(n, o, t)
              : T.from(t[o]));
      };
    ...
    Lc = qu(
      ...
      eo.init,
      function (n, e, t, r) {
        var o = au().concat(t.allowVertical ? fu() : []),
          i = su().concat(t.allowVertical ? lu() : []);
        return [
          wu(hu(o), Pc(fc(jc, Nc))),
          wu(hu(i), Pc(sc(jc, Nc))),
          wu(hu(iu()), Bc),
    ...
    Kc = function (n, e) {
      return function (t, r, i) {
        ...
        return ou(r, i.selectors.row).bind(function (n) {
          var e = Ki(n, i.selectors.cell);
          return yc(e, r).bind(function (r) {
            var o = Ki(t, i.selectors.row);
    ...
    ta = O([wu(hu(cu()), nc)]),
    ra = qu(qc, eo.init, ea, ta, function () {
      return T.some(Yc);
    }),
    oa = [wr("selector"), Dr("execute", Zu), Dr("moveOnTab", !1)],
    ia = function (e, t, r) {
    ...
    sa = O([wu(hu(cu()), nc)]),
    la = qu(oa, eo.init, fa, sa, function () {
      return T.some(ua);
    }),
    da = [
      ii("onSpace"),
    ...
    Fa = function (i, u, c, a) {
      return Ia(i, 0, c, a).fold(
        function (n, e) {
          var t = _a(c) ? e(u, c.config, c.validated) : e(u),
            r = I(t, "components").getOr([]),
            o = On(r, function (n) {
              return Fa(i, u, n, a);
            });
          return [w(w({}, t), { components: o })];
        },
        function (n, e) {
          if (_a(c)) {
    ...
    $a = _r("schema", function () {
      return [Tr("preprocess")];
    }),
    Ua = Dr("defaults", O({})),
    Wa = Dr("overrides", O({})),
    Xa = or([Ha, za, La, Ga, Ua, Wa]),
    ...
    Qa = function (t, r) {
      return function (n) {
        var e = hr("Converting part type", r, n);
        return t(e);
      };
    },
    Za = Qa(Pa.required, Xa),
    nf = (Qa(Pa.external, qa), Qa(Pa.optional, Ya)),
    ef = Qa(Pa.group, Ka),
    tf = O("entirety"),
    rf = function (n, e, t, r) {
      return Vt(
      ...
      return (
        hn(n, function (n) {
          n.fold(T.some, T.none, T.some, T.some).each(function (t) {
            var r = uf(o, t.pname);
            e[t.name] = function (n) {
              var e = hr("Part: " + t.name + " in " + o, or(t.schema), n);
              return w(w({}, r), { config: n, validated: e });
            };
          });
        }),
        e
    ...
    wf = function (n) {
      var e = De(n) ? n.dom()[bf] : null;
      return T.from(e);
    },
    Sf = function (n) {
      return Na(n);
    },
    Of = function (n, e, t, r, o) {
      var i,
        u,
        c =
          ((u = o),
    ...
    kf = function (n) {
      return F(n, "uid") ? n : w(w({}, n), { uid: Sf("uid") });
    };
  var Ef,
    Cf,
    Df,
    ...
    If = function (n) {
      var i = hr("Sketcher for " + n.name, Mf, n),
        e = C(i.apis, pf),
    ...
    Ff = function (n) {
      var e = hr("Sketcher for " + n.name, _f, n),
        t = of(e.name, e.partFields),
        r = C(e.apis, pf),
        ...
        u =
          ...
          bn(
            ...
            function (n, e) {
              ...
              return "class" === e.name
                ? n
                : w(w({}, n), (((t = {})[e.name] = e.value), t));
            },
            {}
          )),
        c = ((r = o), Array.prototype.slice.call(r.dom().classList, 0)),
        a = 0 === i.length ? {} : { innerHtml: Ho(o) };
      return w({ tag: Ee(o), classes: c, attributes: u }, a);
    },
    Af = function (n) {
      var e = Fn(n, { prefix: Di });
      return Bf(e);
    },
    jf = function (n) {
      return { dom: Af(n) };
    ...
    Lf = nf({ schema: [wr("dom")], name: "label" }),
    Gf = function (e) {
      return nf({
        name: e + "-edge",
    ...
    nd = window.Promise
      ...
      : ((Cf =
        ...
        (Ef.resolve = function (e) {
          return e && "object" == typeof e && e.constructor === Ef
            ? e
            : new Ef(function (n) {
                n(e);
              });
  ...
  var fd = function (o, i) {
      ...
      i.url
        ...
        .fold(
          ...
          function (e) {
            ...
            i.link.bind(y).fold(
              function () {
                var n = i.text.toOption().filter(dd).getOr(e);
    ...
    vd = function (n) {
      var e = ke.fromDom(n.selection.getStart());
      return ou(e, "a");
    },
    yd = Gn(),
    bd = function (n, e) {
    ...
    Sd = [wr("find")],
    Od = io({ fields: Sd, name: "composing", apis: wd }),
    Td = If({
      name: "Container",
      factory: function (n) {
        var e = n.dom,
        ...
        return {
          uid: n.uid,
          dom: w({ tag: "div", attributes: w({ role: "presentation" }, t) }, r),
          components: n.components,
    ...
    _d = If({
      ...
      factory: function (n, e) {
        return {
          ...
          dom: {
            tag: (t = n).tag,
            attributes: w({ type: "text" }, t.inputAttributes),
    ...
    Fd = [Dr("tabAttr", "data-alloy-tabstop")],
    Rd = io({ fields: Fd, name: "tabstopping", active: Id }),
        ...
        spec: Td.sketch({
          ...
          containerBehaviours: ro([
            ...
            xd("input-clearing", [
              Nr(Zn(), function (n) {
                var e = t.get(n);
                (0 < ss.getValue(e).length ? Ti.off : Ti.on)(n);
              }),
            ]),
          ]),
        }),
    ...
    Ud = function (n, e) {
      return Nd(n, e)
        ...
        : "true" === lo(n.element(), "aria-disabled");
    },
    Wd = /* */ Object.freeze({
      __proto__: null,
      enable: $d,
    ...
    Yd = io({ fields: qd, name: "disabling", active: Xd, apis: Wd }),
    Kd = [Oa("formBehaviours", [ss])],
    Jd = function (n) {
    ...
    tm = function (n) {
      var r = "navigateEvent",
        ...
        i = function (n, o) {
          var i = Ki(n.element(), "." + Mi("serialised-dialog-screen"));
    ...
    hm = function (n) {
      var e,
        i = an((e = n)) ? { can: O(!0), abort: O(!1), run: e } : e;
      return function (n, e) {
    ...
    ym = function (n, i) {
      var e = _(n, function (r, o) {
        return (1 === r.length ? mt.value(r[0].handler()) : vm(r, i, o)).map(
          function (n) {
            var e = hm(n),
              t =
                1 < r.length
    ...
    Tm = function (n, e, t) {
      ...
      return (
        (i = f),
        w(w({}, (o = u)), {
          attributes: w(w({}, o.attributes), i.attributes),
          styles: w(w({}, o.styles), i.styles),
    ...
    Cm = function (n) {
      var e,
        ...
        r = t.events,
        o = c(t, ["events"]),
        i = ((e = I(o, "components").getOr([])), pn(e, Im)),
        u = w(w({}, o), { events: w(w({}, um), r), components: i });
    ...
    Mm = function (n) {
      var e = hr("external.component", rr([wr("element"), Tr("uid")]), n),
        t = Do(am());
    ...
    Im = function (e) {
      return I(e, mf).fold(
        function () {
          var n = e.hasOwnProperty("uid") ? e : w({ uid: _m("") }, e);
    ...
    Pm = [
      ...
      ai("builder", function (n) {
        return {
          dom: n.dom,
          domModification: w(w({}, n.domModification), {
            attributes: w(
              w(
                w(
                  {
          ...
          behaviours: Ca(n.itemBehaviours, [
            n.toggling.fold(Ti.revoke, function (n) {
              return Ti.config(w({ aria: { mode: "checked" } }, n));
            }),
            Bi.config({
    ...
    $m = yr("type", { widget: Gm, item: Pm, separator: Hm }),
    Um = O([
      ef({
        factory: {
          sketch: function (n) {
            var e = hr("menu.spec item", $m, n);
            return e.builder(e);
          },
        },
        name: "items",
        ...
        defaults: function (n, e) {
          return e.hasOwnProperty("uid") ? e : w(w({}, e), { uid: Sf("item") });
        },
            ...
            : ((o = n),
              (i = function (n) {
                for (var e = 0; e < n.childNodes.length; e++) {
                  var t = ke.fromDom(n.childNodes[e]);
      ...
      init: function () {
        ...
        return {
          ...
          getTriggeringPath: function (n, u) {
            var e = vn(t(n).toArray(), function (n) {
              return l(n).isSome();
            });
            return I(c.get(), n).bind(function (n) {
              var i = kn(e.concat(n));
    ...
    _g = function (n) {
      var e = n.getParam("toolbar", Ao, "array");
      return (on(e) ? Mg : Dg)(e);
    },
    Ig = function (t, o) {
      var n = function (t) {
    ...
    Fg = function (n) {
      var e,
        ...
        u,
        c,
        a = ke.fromDom(We(n).getOr(n.target)),
        f = function () {
    ...
    Ng = tinymce.util.Tools.resolve("tinymce.util.Delay"),
    Pg = function (n) {
    ...
    Hg = function (r, e) {
      var n = ke.fromDom(r),
        o = null,
        t = Ag(n, "orientationchange", function () {
          Ng.clearInterval(o);
          var n = Pg(r);
          e.onChange(n),
            i(function () {
        ...
        i = function (n) {
          ...
          o = Ng.setInterval(function () {
            e !== r.innerHeight
              ...
              : 20 < t && (Ng.clearInterval(o), n(T.none())),
              t++;
          }, 50);
        };
      return {
    ...
    Lg = function (t) {
      var u = Do(T.none()),
        ...
        o = (function n(t, r) {
          ...
          return {
            cancel: function () {
              null !== o && (x.clearTimeout(o), (o = null));
            },
            schedule: function () {
              for (var n = [], e = 0; e < arguments.length; e++)
                n[e] = arguments[e];
  ...
  var Xg,
    ...
    mp = function (n) {
      var e = ke.fromDom(n.anchorNode),
        t = ke.fromDom(n.focusNode);
    ...
    yp = function (n) {
      ...
      return e !== undefined && 0 < e.rangeCount
        ? (function (t) {
            if (t.collapsed) {
              var r = ke.fromDom(t.startContainer);
              return Ne(r)
                .bind(function (n) {
                  var e = ep.exact(r, t.startOffset, n, Kg(n));
    ...
    bp = function (n) {
      n.focus();
      var e = ke.fromDom(n.document.body);
    ...
    Tp = function (n, u) {
      var e = ke.fromDom(u.document.body),
        t = Ag(ke.fromDom(n), "resize", function () {
          Op(n, e).each(function (i) {
            var n;
            (0 < (n = yp(u)).length ? T.some(n[0]).map(Sp) : T.none()).each(
              function (n) {
                var e,
                  t,
                  r,
          ...
          return (
            ...
            T.some(ke.fromDom(n.dom().contentWindow.document)).bind(function (
              ...
              return kp(a).map(function (o) {
                var n = ke.fromDom(i.dom().documentElement),
    ...
    Fp = "data-ephox-mobile-fullscreen-style",
    Rp = "position:absolute!important;",
    Vp =
    ...
    Lp = function (n) {
      var e = hr("Getting AndroidWebapp schema", zp, n);
    ...
    Gp = O([wr("dom"), Dr("shell", !0), Oa("toolbarBehaviours", [ng])]),
    $p = O([
      nf({
        name: "groups",
        overrides: function () {
  ...
  var Zp = function (n) {
    ...
    dh = function (n, e, t) {
      var r = uh(e, n.element());
      ("0px" === r ? sh : lh)(n, e, t, T.some(r));
    },
    mh = function (n, e, t) {
      var r = oh(n, e),
        o = Oo(r, e.shrinkingClass),
        i = uh(e, n.element());
      fh(n, e);
      var u = uh(e, n.element());
      (o
        ? function () {
    ...
    Oh = rr([Sr("triggerEvent", xr), Dr("stopBackspace", !0)]),
    Th = function (e, n) {
      var t,
        r,
        o,
        i,
        u = hr("Getting GUI events settings", Oh, n),
        c = Lg(u),
        a = pn(
          [
            "touchstart",
    ...
    Eh = It([{ stopped: [] }, { resume: ["element"] }, { complete: [] }]),
    Ch = function (n, r, e, t, o, i) {
      var u,
        c,
        a,
        f,
  ...
  ($h = undefined),
    ...
    (Xh = undefined),
    (function (n) {
      if ("object" == typeof Uh && void 0 !== Wh) Wh.exports = n();
      else if ("function" == typeof $h && $h.amd) $h([], n);
      else {
      ...
      return (function s(i, u, c) {
        ...
        for (var f = "function" == typeof Xh && Xh, n = 0; n < c.length; n++)
          a(c[n]);
        return a;
      })(
        {
  ...
  var Kh,
    ...
    iv = function (n) {
      var e,
        t = Pg(n).isPortrait(),
        r = ov((e = n).screen.width, e.screen.height),
    ...
    fv = "data-" + Mi("position-y-fixed"),
    sv = "data-" + Mi("y-property"),
    lv = "data-" + Mi("scrolling"),
    dv = "data-" + Mi("last-window-height"),
    mv = function (n) {
      return Wg(n, fv);
    },
    gv = function (n, e) {
    ...
    xv = "data-" + Mi("last-scroll-top"),
    wv = function (n) {
      var e = Li(n, "top").getOr("0");
  ...
  var kv = function (u, n) {
    ...
    Mv = function (i, u, n, t, e, r) {
      var o = (function f(t) {
          var r = Do(Zh.pure({}));
          return {
            start: function (e) {
              var n = Zh.nu(function (n) {
                return t(e).get(n);
              });
              r.set(n);
            },
        ...
        a = Ag(ke.fromDom(t), "scroll", function () {
    ...
    _v = function (n) {
      var a = n.cWin,
        ...
        c = yv(f, e, t, s),
        l = o(u, a, Ye(), r),
        d = Hg(i, { onChange: S, onReady: c.refresh });
      d.onAdjustment(function () {
        c.refresh();
      });
      var m = Ag(ke.fromDom(i), "resize", function () {
        ...
        p = (function v(t, e) {
          ...
          var o = Ag(r, "touchstart", function (n) {
              n.prevent(), zh(t, e), u();
            }),
            i = function (n) {
              var e = ke.fromTag("span");
              return (
  ...
  function Fv(n) {
    var e = Nh({ classes: [Mi("ios-container")] }),
      t = Qp(),
      r = nm(),
      o = Zp(r),
      i = nh(),
    ...
    return {
      ...
      init: function (n) {
        r.set(
          (function (n) {
            var e = hr("Getting IosWebapp schema", zp, n);
            Ni(e.toolstrip, "width", "100%"),
  ...
  var Rv = tinymce.util.Tools.resolve("tinymce.EditorManager"),
    Vv = function (n, e, t) {
      ...
      return {
        ...
        renderUI: function () {
          ...
          var o,
            ...
            p = (Gn().os.isAndroid()
              ? function s(n) {
                  var e = Nh({ classes: [Mi("android-container")] }),
                    t = Qp(),
                    r = nm(),
                    o = Zp(r),
                    i = nh(),
          ...
          return (
            b.on("init", function () {
              p.init({
                editor: {
                  ...
                  onTapContent: function (n) {
                    var e = n.target();
                    if ("img" === Ee(e)) b.selection.select(e.dom()), n.kill();
                    else if ("a" === Ee(e)) {
                      p.system()
                        ...
                        .each(function (n) {
                          Co.isAlpha(n) &&
                            (function (n) {
                              ...
                              var t = x.document.createEvent("MouseEvents");
                              t.initMouseEvent(
                                "click",
                                !0,
                                !0,
              ...
              var t,
                ...
                g = Do({ backToMask: [c], backToReadOnly: [a] });
              (o = p),
