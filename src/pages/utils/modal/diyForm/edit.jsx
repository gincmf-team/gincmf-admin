...
import { Modal, Row, Col, Input, InputNumber, DatePicker, message, Typography, Rate, Radio, Checkbox, Table } from 'antd';
...
const Index = ((props, ref) => {
    ...
    useImperativeHandle(ref, () => ({
        open: (valueId, field) => {
            ...
            if (field.remarkItem) {
                setRemarkItem(field.remarkItem)
            }
    ...
    const onModalOk = async () => {
        ...
        const param = { schedule_time: dateValue, json_config: JSON.stringify(formConfig) }
        ...
        if (item.type === 'input') {
            return (
                ...
                >
                    ...
                    <Input onChange={(e) => { InputOnChange(e, index) }} value={item.data.value} placeholder={item.data.placeholder} />
                </div>
        ...
        if (item.type === 'textarea') {
            return (
                ...
                >
                    ...
                    <Input.TextArea onChange={(e) => { InputOnChange(e, index) }} value={item.data.value} placeholder={item.data.placeholder} style={{ resize: "none" }} />
                </div>
        ...
        if (item.type === 'number') {
            return (
                ...
                >
                    ...
                    <InputNumber onChange={(value) => { InputValueOnChange(value, index) }} value={item.data.value} placeholder={item.data.placeholder} style={{ width: "100%" }} />
                </div>
            )
        }
        ...
        if (item.type === 'rate') {
            return (
                ...
                >
                    ...
                    <Rate onChange={(value) => { InputValueOnChange(value, index) }} value={item.data.value} />
                </div>
            )
        }
        ...
        if (item.type === 'radio') {
            return (
                ...
                >
                    ...
                    <Radio.Group onChange={(value) => { InputOnChange(value, index) }} value={item.data.value}>
                        {
        ...
        if (item.type === 'checkbox') {
            return (
                ...
                >
                    ...
                    <Checkbox.Group onChange={(value) => { InputValueOnChange(value, index) }} options={item.data.options} value={item.data.value} />
                </div>
            )
        }
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <DatePicker value={moment(dateValue, dateFormat)} format={dateFormat} style={{ width: "100%" }} onChange={onDatePickerChange} />
                </div>
